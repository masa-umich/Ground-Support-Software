...
### Autogenerated by firmware-libraries/SerialComms/python/cmd_file_generator.py on Sat Jan 23 12:09:12 2021
...
class _S2_InterfaceAutogen:
	...
	def s2_command(self, ser, cmd_info):
		...
		# set_kp()
			...
			# gain
			packet.append((int(cmd_info["args"][0]*100) >> 0) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 8) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 16) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 24) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 32) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 40) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 48) & 0xFF)
			packet.append((int(cmd_info["args"][0]*100) >> 56) & 0xFF)
		# set_ki()
		elif (command_id == 14):
			# gain
			packet.append((int(cmd_info["args"][0]*100) >> 0) & 0xFF)
