...
### Autogenerated by firmware-libraries/SerialComms/python/cmd_file_generator.py on Thu Jul 29 23:00:13 2021
...
class _S2_InterfaceAutogen:
	def __init__(self):
		...
		self.cmd_names_dict = {
			...
			"set_autosequence_fuel_first"	:	38,
			"set_autosequence_lox_first"	:	39,
			"set_autosequence_mpv_delay"	:	40,
			"set_engine_test_duration"	:	41,
			"set_engine_purge_duration"	:	42,
			"clear_status_flags"	:	43,
			"start_simulation"	:	44,
			"advance_simulation"	:	45,
			"stop_simulation"	:	46,
			"set_pt_lower_voltage"	:	47,
			"set_pt_upper_voltage"	:	48,
			"set_pt_upper_pressure"	:	49
		}
		...
		self.cmd_args_dict = {
			...
			38	:	[],
			39	:	[],
			40	:	[('mpv_delay_ms', 'uint16_t', 1)],
			41	:	[('engine_test_duration', 'uint32_t', 1)],
			42	:	[('engine_purge_duration', 'uint32_t', 1)],
			43	:	[],
			44	:	[],
			45	:	[],
			46	:	[],
			47	:	[('pt_num', 'uint8_t', 1), ('lower_voltage', 'float', 10)],
			48	:	[('pt_num', 'uint8_t', 1), ('upper_voltage', 'float', 10)],
			49	:	[('pt_num', 'uint8_t', 1), ('pressure_range', 'float', 1)]
		}
