...
### Autogenerated by firmware-libraries/SerialComms/python/cmd_file_generator.py on Thu Aug 26 17:51:31 2021
...
class _S2_InterfaceAutogen:
	def __init__(self):
		...
		self.cmd_args_dict = {
			...
			47	:	[],
			48	:	[],
			49	:	[('pt_num', 'uint8_t', 1), ('mV_per_psi', 'float', 10000), ('mV_offset', 'float', 1)],
