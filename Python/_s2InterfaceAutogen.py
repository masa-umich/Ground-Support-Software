...
### Autogenerated by firmware-libraries/SerialComms/python/cmd_file_generator.py on Tue Aug 17 22:03:31 2021
...
class _S2_InterfaceAutogen:
	def __init__(self):
		...
		self.cmd_names_dict = {
			...
			"send_gse_vlv_cmd"	:	53,
			"set_automatic_abort_enable"	:	54,
			"reset_micro"	:	55,
			"clear_serial_buffer"	:	56
		}
		...
		self.cmd_args_dict = {
			...
			54	:	[('abort_enable_status', 'uint8_t', 1)],
			55	:	[],
			56	:	[]
		}
