...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Thu Feb 11 18:23:46 2021
...
class TelemParse:
	...
	def __init__(self):
		...
		self.items[79] = 'elapsed_test_duration' 
