...
### calibrationParse.py
### Autogenerated by firmware-libraries/SerialComms/python/calibration_file_generator.py on Sat Aug 21 15:59:35 2021
...
class GSEControllerCalibrations:
	...
	def __init__(self):
		...
		self.units[self.items[8]] = "mV"
		self.units[self.items[9]] = "mV"
		self.units[self.items[10]] = "mV"
		self.units[self.items[11]] = "mV"
		self.units[self.items[12]] = "mV"
		self.units[self.items[13]] = "mV"
		...
		self.units[self.items[20]] = "mV"
		self.units[self.items[21]] = "mV"
		self.units[self.items[22]] = "mV"
		self.units[self.items[23]] = "mV"
		self.units[self.items[24]] = "mV"
		self.units[self.items[25]] = "mV"
		self.units[self.items[26]] = "mV"
		self.units[self.items[27]] = "mV"
		self.units[self.items[28]] = "mV"
		self.units[self.items[29]] = "mV"
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[30]] = float((float(struct.unpack("<i", packet[100:104])[0]))/1)
		self.dict[self.items[31]] = float((float(struct.unpack("<h", packet[104:106])[0]))/1)
		self.dict[self.items[32]] = float((float(struct.unpack("<h", packet[106:108])[0]))/1)
		self.dict[self.items[33]] = float((float(struct.unpack("<h", packet[108:110])[0]))/1)
		self.dict[self.items[34]] = float((float(struct.unpack("<h", packet[110:112])[0]))/1)
		self.dict[self.items[35]] = float((float(struct.unpack("<h", packet[112:114])[0]))/1)
		self.dict[self.items[36]] = float((float(struct.unpack("<h", packet[114:116])[0]))/1)
		self.dict[self.items[37]] = float((float(struct.unpack("<h", packet[116:118])[0]))/1)
		self.dict[self.items[38]] = float((float(struct.unpack("<h", packet[118:120])[0]))/1)
		self.dict[self.items[39]] = float((float(struct.unpack("<h", packet[120:122])[0]))/1)
		self.dict[self.items[40]] = float((float(struct.unpack("<h", packet[122:124])[0]))/1)
		self.dict[self.items[41]] = float((float(struct.unpack("<h", packet[124:126])[0]))/1)
		self.dict[self.items[42]] = float((float(struct.unpack("<h", packet[126:128])[0]))/1)
		self.dict[self.items[43]] = float((float(struct.unpack("<h", packet[128:130])[0]))/1)
		self.dict[self.items[44]] = float((float(struct.unpack("<h", packet[130:132])[0]))/1)
		self.dict[self.items[45]] = float((float(struct.unpack("<h", packet[132:134])[0]))/1)
		self.dict[self.items[46]] = float((float(struct.unpack("<h", packet[134:136])[0]))/1)
		self.dict[self.items[47]] = float((float(struct.unpack("<h", packet[136:138])[0]))/1)
		self.dict[self.items[48]] = float((float(struct.unpack("<h", packet[138:140])[0]))/1)
		self.dict[self.items[49]] = float((float(struct.unpack("<h", packet[140:142])[0]))/1)
		self.dict[self.items[50]] = float((float(struct.unpack("<h", packet[142:144])[0]))/1)
		self.dict[self.items[51]] = float((float(struct.unpack("<h", packet[144:146])[0]))/1)
