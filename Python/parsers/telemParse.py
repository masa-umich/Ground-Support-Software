...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Thu Feb 18 18:45:37 2021
...
class TelemParse:
	...
	def __init__(self):
		...
		self.items[69] = 'tnk0.tp' 
		self.items[70] = 'tnk1.tp' 
		self.items[71] = 'tnk0.hp' 
		self.items[72] = 'tnk1.hp' 
		self.items[73] = 'tnk0.lp' 
		self.items[74] = 'tnk1.lp' 
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[8]] = float((float(struct.unpack("<h", packet[15:17])[0]))/10)
		self.dict[self.items[9]] = float((float(struct.unpack("<h", packet[17:19])[0]))/10)
		self.dict[self.items[10]] = float((float(struct.unpack("<h", packet[19:21])[0]))/10)
		self.dict[self.items[11]] = float((float(struct.unpack("<h", packet[21:23])[0]))/10)
		self.dict[self.items[12]] = float((float(struct.unpack("<h", packet[23:25])[0]))/10)
		self.dict[self.items[13]] = float((float(struct.unpack("<h", packet[25:27])[0]))/10)
		...
		self.dict[self.items[57]] = float((float(struct.unpack("<H", packet[96:98])[0]))/10)
		self.dict[self.items[58]] = float((float(struct.unpack("<H", packet[98:100])[0]))/10)
		self.dict[self.items[59]] = float((float(struct.unpack("<H", packet[100:102])[0]))/10)
		self.dict[self.items[60]] = float((float(struct.unpack("<H", packet[102:104])[0]))/10)
		self.dict[self.items[61]] = float((float(struct.unpack("<H", packet[104:106])[0]))/10)
		self.dict[self.items[62]] = float((float(struct.unpack("<H", packet[106:108])[0]))/10)
		self.dict[self.items[63]] = float((float(struct.unpack("<h", packet[108:110])[0]))/10)
		self.dict[self.items[64]] = float((float(struct.unpack("<h", packet[110:112])[0]))/10)
		self.dict[self.items[65]] = float((float(struct.unpack("<h", packet[112:114])[0]))/10)
		self.dict[self.items[66]] = float((float(struct.unpack("<h", packet[114:116])[0]))/10)
		self.dict[self.items[67]] = float((float(struct.unpack("<h", packet[116:118])[0]))/10)
		self.dict[self.items[68]] = float((float(struct.unpack("<h", packet[118:120])[0]))/10)
		...
		self.dict[self.items[75]] = float((float(struct.unpack("<i", packet[132:136])[0]))/10)
		self.dict[self.items[76]] = float((float(struct.unpack("<i", packet[136:140])[0]))/10)
		self.dict[self.items[77]] = float((float(struct.unpack("<i", packet[140:144])[0]))/10)
		self.dict[self.items[78]] = float((float(struct.unpack("<i", packet[144:148])[0]))/10)
		self.dict[self.items[79]] = int((float(struct.unpack("<I", packet[148:152])[0]))/1)
		self.dict[self.items[80]] = int((float(struct.unpack("<Q", packet[152:160])[0]))/1)
		self.dict[self.items[81]] = int((float(struct.unpack("<I", packet[160:164])[0]))/1)
		self.dict[self.items[82]] = int((float(struct.unpack("<I", packet[164:168])[0]))/1)
		self.dict[self.items[83]] = int((float(struct.unpack("<I", packet[168:172])[0]))/1)
		self.dict[self.items[84]] = int((float(struct.unpack("<B", packet[172:173])[0]))/1)
		self.log_string = str(self.dict[self.items[6]]/1000000.0) + ',' + str(self.dict[self.items[7]]) + ',' + str(self.dict[self.items[8]]) + ',' + str(self.dict[self.items[9]]) + ',' + str(self.dict[self.items[10]]) + ',' + str(self.dict[self.items[11]]) + ',' + str(self.dict[self.items[12]]) + ',' + str(self.dict[self.items[13]]) + ',' + str(self.dict[self.items[14]]) + ',' + str(self.dict[self.items[15]]) + ',' + str(self.dict[self.items[16]]) + ',' + str(self.dict[self.items[17]]) + ',' + str(self.dict[self.items[18]]) + ',' + str(self.dict[self.items[19]]) + ',' + str(self.dict[self.items[20]]) + ',' + str(self.dict[self.items[21]]) + ',' + str(self.dict[self.items[22]]) + ',' + str(self.dict[self.items[23]]) + ',' + str(self.dict[self.items[24]]) + ',' + str(self.dict[self.items[25]]) + ',' + str(self.dict[self.items[26]]) + ',' + str(self.dict[self.items[27]]) + ',' + str(self.dict[self.items[28]]) + ',' + str(self.dict[self.items[29]]) + ',' + str(self.dict[self.items[30]]) + ',' + str(self.dict[self.items[31]]) + ',' + str(self.dict[self.items[32]]) + ',' + str(self.dict[self.items[33]]) + ',' + str(self.dict[self.items[34]]) + ',' + str(self.dict[self.items[35]]) + ',' + str(self.dict[self.items[36]]) + ',' + str(self.dict[self.items[37]]) + ',' + str(self.dict[self.items[38]]) + ',' + str(self.dict[self.items[39]]) + ',' + str(self.dict[self.items[40]]) + ',' + str(self.dict[self.items[41]]) + ',' + str(self.dict[self.items[42]]) + ',' + str(self.dict[self.items[43]]) + ',' + str(self.dict[self.items[44]]) + ',' + str(self.dict[self.items[45]]) + ',' + str(self.dict[self.items[46]]) + ',' + str(self.dict[self.items[47]]) + ',' + str(self.dict[self.items[48]]) + ',' + str(self.dict[self.items[49]]) + ',' + str(self.dict[self.items[50]]) + ',' + str(self.dict[self.items[51]]) + ',' + str(self.dict[self.items[52]]) + ',' + str(self.dict[self.items[53]]) + ',' + str(self.dict[self.items[54]]) + ',' + str(self.dict[self.items[55]]) + ',' + str(self.dict[self.items[56]]) + ',' + str(self.dict[self.items[57]]) + ',' + str(self.dict[self.items[58]]) + ',' + str(self.dict[self.items[59]]) + ',' + str(self.dict[self.items[60]]) + ',' + str(self.dict[self.items[61]]) + ',' + str(self.dict[self.items[62]]) + ',' + str(self.dict[self.items[63]]) + ',' + str(self.dict[self.items[64]]) + ',' + str(self.dict[self.items[65]]) + ',' + str(self.dict[self.items[66]]) + ',' + str(self.dict[self.items[67]]) + ',' + str(self.dict[self.items[68]]) + ',' + str(self.dict[self.items[69]]) + ',' + str(self.dict[self.items[70]]) + ',' + str(self.dict[self.items[71]]) + ',' + str(self.dict[self.items[72]]) + ',' + str(self.dict[self.items[73]]) + ',' + str(self.dict[self.items[74]]) + ',' + str(self.dict[self.items[75]]) + ',' + str(self.dict[self.items[76]]) + ',' + str(self.dict[self.items[77]]) + ',' + str(self.dict[self.items[78]]) + ',' + str(self.dict[self.items[79]]) + ',' + str(self.dict[self.items[80]]) + ',' + str(self.dict[self.items[81]]) + ',' + str(self.dict[self.items[82]]) + ',' + str(self.dict[self.items[83]]) + ',' + str(self.dict[self.items[84]]) + ','