...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Sat Mar 27 14:40:10 2021
...
class PressurizationController:
	...
	def __init__(self):
		...
		self.items[84] = 'micros' 
		self.items[85] = 'telem_rate' 
		self.items[86] = 'adc_rate' 
		self.items[87] = 'flash_mem' 
		self.items[88] = 'own_board_addr' 
		...
		self.units[self.items[84]] = "us"
		self.units[self.items[85]] = "Hz"
		self.units[self.items[86]] = "Hz"
		self.units[self.items[87]] = "bytes"
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[84]] = int((float(struct.unpack("<Q", packet[187:195])[0]))/1)
		self.dict[self.items[85]] = int((float(struct.unpack("<I", packet[195:199])[0]))/1)
		...
		self.dict[self.items[88]] = int((float(struct.unpack("<B", packet[207:208])[0]))/1)
