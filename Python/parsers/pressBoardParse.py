...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Mon Mar  8 12:56:20 2021
...
class PressurizationController:
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[56]] = float((float(struct.unpack("<h", packet[93:95])[0]))/10)
		self.dict[self.items[57]] = float((float(struct.unpack("<h", packet[95:97])[0]))/10)
		self.dict[self.items[58]] = float((float(struct.unpack("<H", packet[97:99])[0]))/10)
		self.dict[self.items[59]] = float((float(struct.unpack("<H", packet[99:101])[0]))/10)
		self.dict[self.items[60]] = float((float(struct.unpack("<H", packet[101:103])[0]))/10)
		self.dict[self.items[61]] = float((float(struct.unpack("<H", packet[103:105])[0]))/10)
		self.dict[self.items[62]] = float((float(struct.unpack("<H", packet[105:107])[0]))/10)
		self.dict[self.items[63]] = float((float(struct.unpack("<H", packet[107:109])[0]))/10)
		self.dict[self.items[64]] = float((float(struct.unpack("<h", packet[109:111])[0]))/10)
		self.dict[self.items[65]] = float((float(struct.unpack("<h", packet[111:113])[0]))/10)
		self.dict[self.items[66]] = float((float(struct.unpack("<h", packet[113:115])[0]))/10)
		self.dict[self.items[67]] = float((float(struct.unpack("<h", packet[115:117])[0]))/10)
		self.dict[self.items[68]] = float((float(struct.unpack("<h", packet[117:119])[0]))/10)
		self.dict[self.items[69]] = float((float(struct.unpack("<h", packet[119:121])[0]))/10)
		self.dict[self.items[70]] = float((float(struct.unpack("<h", packet[121:123])[0]))/10)
		self.dict[self.items[71]] = float((float(struct.unpack("<h", packet[123:125])[0]))/10)
		self.dict[self.items[72]] = float((float(struct.unpack("<h", packet[125:127])[0]))/10)
		self.dict[self.items[73]] = float((float(struct.unpack("<h", packet[127:129])[0]))/10)
		self.dict[self.items[74]] = float((float(struct.unpack("<h", packet[129:131])[0]))/10)
		self.dict[self.items[75]] = float((float(struct.unpack("<h", packet[131:133])[0]))/10)
		self.dict[self.items[76]] = float((float(struct.unpack("<i", packet[133:137])[0]))/10)
		self.dict[self.items[77]] = float((float(struct.unpack("<i", packet[137:141])[0]))/10)
		self.dict[self.items[78]] = float((float(struct.unpack("<i", packet[141:145])[0]))/10)
		self.dict[self.items[79]] = float((float(struct.unpack("<i", packet[145:149])[0]))/10)
		self.dict[self.items[80]] = int((float(struct.unpack("<I", packet[149:153])[0]))/1)
		self.dict[self.items[81]] = int((float(struct.unpack("<Q", packet[153:161])[0]))/1)
		self.dict[self.items[82]] = int((float(struct.unpack("<I", packet[161:165])[0]))/1)
		self.dict[self.items[83]] = int((float(struct.unpack("<I", packet[165:169])[0]))/1)
		self.dict[self.items[84]] = int((float(struct.unpack("<I", packet[169:173])[0]))/1)
		self.dict[self.items[85]] = int((float(struct.unpack("<B", packet[173:174])[0]))/1)
