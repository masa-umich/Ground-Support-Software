...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Wed Aug 18 16:51:01 2021
...
class GSEController:
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[15]] = float((float(struct.unpack("<h", packet[28:30])[0]))/10)
		self.dict[self.items[16]] = float((float(struct.unpack("<h", packet[30:32])[0]))/10)
		self.dict[self.items[17]] = float((float(struct.unpack("<h", packet[32:34])[0]))/10)
		self.dict[self.items[18]] = float((float(struct.unpack("<h", packet[34:36])[0]))/10)
		self.dict[self.items[19]] = float((float(struct.unpack("<h", packet[36:38])[0]))/10)
		self.dict[self.items[20]] = float((float(struct.unpack("<h", packet[38:40])[0]))/10)
		self.dict[self.items[21]] = float((float(struct.unpack("<h", packet[40:42])[0]))/10)
		self.dict[self.items[22]] = float((float(struct.unpack("<h", packet[42:44])[0]))/10)
		self.dict[self.items[23]] = float((float(struct.unpack("<h", packet[44:46])[0]))/10)
		self.dict[self.items[24]] = float((float(struct.unpack("<h", packet[46:48])[0]))/100)
		self.dict[self.items[25]] = float((float(struct.unpack("<h", packet[48:50])[0]))/100)
		self.dict[self.items[26]] = float((float(struct.unpack("<h", packet[50:52])[0]))/10)
		self.dict[self.items[27]] = float((float(struct.unpack("<h", packet[52:54])[0]))/10)
		self.dict[self.items[28]] = float((float(struct.unpack("<h", packet[54:56])[0]))/10)
		self.dict[self.items[29]] = float((float(struct.unpack("<h", packet[56:58])[0]))/10)
		self.dict[self.items[30]] = float((float(struct.unpack("<h", packet[58:60])[0]))/10)
		...
		self.dict[self.items[142]] = int((float(struct.unpack("<B", packet[232:233])[0]))/1)
		self.dict[self.items[143]] = int((float(struct.unpack("<B", packet[233:234])[0]))/1)
