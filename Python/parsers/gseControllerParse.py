...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Sat Apr  9 09:28:27 2022
...
class GSEController:
    def __init__(self):
        ...
        self.items[48] = "vlv9.i"
        self.items[49] = "vlv10.i"
        self.items[50] = "vlv11.i"
        self.items[51] = "vlv12.i"
        self.items[52] = "vlv13.i"
        self.items[53] = "vlv14.i"
        self.items[54] = "vlv15.i"
        self.items[55] = "vlv16.i"
        self.items[56] = "vlv17.i"
        self.items[57] = "vlv18.i"
        self.items[58] = "vlv19.i"
        self.items[59] = "vlv20.i"
        self.items[60] = "vlv21.i"
        self.items[61] = "vlv22.i"
        self.items[62] = "vlv23.i"
        self.items[63] = "vlv24.i"
        self.items[64] = "vlv25.i"
        self.items[65] = "vlv26.i"
        self.items[66] = "vlv27.i"
        self.items[67] = "vlv28.i"
        self.items[68] = "vlv29.i"
        self.items[69] = "vlv30.i"
        self.items[70] = "vlv31.i"
        ...
        self.items[80] = "vlv9.e"
        self.items[81] = "vlv10.e"
        self.items[82] = "vlv11.e"
        self.items[83] = "vlv12.e"
        self.items[84] = "vlv13.e"
        self.items[85] = "vlv14.e"
        self.items[86] = "vlv15.e"
        self.items[87] = "vlv16.e"
        self.items[88] = "vlv17.e"
        self.items[89] = "vlv18.e"
        self.items[90] = "vlv19.e"
        self.items[91] = "vlv20.e"
        self.items[92] = "vlv21.e"
        self.items[93] = "vlv22.e"
        self.items[94] = "vlv23.e"
        self.items[95] = "vlv24.e"
        self.items[96] = "vlv25.e"
        self.items[97] = "vlv26.e"
        self.items[98] = "vlv27.e"
        self.items[99] = "vlv28.e"
        self.items[100] = "vlv29.e"
        self.items[101] = "vlv30.e"
        self.items[102] = "vlv31.e"
        self.items[103] = "e3v"
        self.items[104] = "e5v"
        self.items[105] = "e28v"
        self.items[106] = "i5v"
        ...
        self.items[140] = "tvlv"
        self.items[141] = "tmtr"
        self.items[142] = "LOGGING_ACTIVE"
        self.items[143] = "TELEM_ACTIVE"
    ...
    def parse_packet(self, packet):
        ...
        self.dict[self.items[9]] = float(
            (float(struct.unpack("<h", packet[16:18])[0])) / 10
        )
        self.dict[self.items[10]] = float(
            (float(struct.unpack("<h", packet[18:20])[0])) / 10
        )
        self.dict[self.items[11]] = float(
            (float(struct.unpack("<h", packet[20:22])[0])) / 10
        )
        self.dict[self.items[12]] = float(
            (float(struct.unpack("<h", packet[22:24])[0])) / 10
        )
        self.dict[self.items[13]] = float(
            (float(struct.unpack("<h", packet[24:26])[0])) / 10
        )
        self.dict[self.items[14]] = float(
            (float(struct.unpack("<h", packet[26:28])[0])) / 10
        )
        self.dict[self.items[15]] = float(
            (float(struct.unpack("<h", packet[28:30])[0])) / 10
        )
        self.dict[self.items[16]] = float(
            (float(struct.unpack("<h", packet[30:32])[0])) / 10
        )
        self.dict[self.items[17]] = float(
            (float(struct.unpack("<h", packet[32:34])[0])) / 10
        )
        self.dict[self.items[18]] = float(
            (float(struct.unpack("<h", packet[34:36])[0])) / 10
        )
        self.dict[self.items[19]] = float(
            (float(struct.unpack("<h", packet[36:38])[0])) / 10
        )
        self.dict[self.items[20]] = float(
            (float(struct.unpack("<h", packet[38:40])[0])) / 10
        )
        self.dict[self.items[21]] = float(
            (float(struct.unpack("<h", packet[40:42])[0])) / 10
        )
        self.dict[self.items[22]] = float(
            (float(struct.unpack("<h", packet[42:44])[0])) / 10
        )
        self.dict[self.items[23]] = float(
            (float(struct.unpack("<h", packet[44:46])[0])) / 10
        )
        self.dict[self.items[24]] = float(
            (float(struct.unpack("<h", packet[46:48])[0])) / 10
        )
        self.dict[self.items[25]] = float(
            (float(struct.unpack("<h", packet[48:50])[0])) / 10
        )
        self.dict[self.items[26]] = float(
            (float(struct.unpack("<h", packet[50:52])[0])) / 10
        )
        self.dict[self.items[27]] = float(
            (float(struct.unpack("<h", packet[52:54])[0])) / 1
        )
        self.dict[self.items[28]] = float(
            (float(struct.unpack("<h", packet[54:56])[0])) / 1
        )
        self.dict[self.items[29]] = float(
            (float(struct.unpack("<h", packet[56:58])[0])) / 10
        )
        self.dict[self.items[30]] = float(
            (float(struct.unpack("<h", packet[58:60])[0])) / 10
        )
        self.dict[self.items[31]] = float(
            (float(struct.unpack("<h", packet[60:62])[0])) / 100
        )
        self.dict[self.items[32]] = float(
            (float(struct.unpack("<h", packet[62:64])[0])) / 100
        )
        self.dict[self.items[33]] = int(
            (float(struct.unpack("<B", packet[64:65])[0])) / 1
        )
        self.dict[self.items[34]] = int(
            (float(struct.unpack("<H", packet[65:67])[0])) / 1
        )
        self.dict[self.items[35]] = float(
            (float(struct.unpack("<H", packet[67:69])[0])) / 1
        )
        self.dict[self.items[36]] = float(
            (float(struct.unpack("<H", packet[69:71])[0])) / 1
        )
        self.dict[self.items[37]] = float(
            (float(struct.unpack("<H", packet[71:73])[0])) / 1
        )
        self.dict[self.items[38]] = float(
            (float(struct.unpack("<H", packet[73:75])[0])) / 1
        )
        self.dict[self.items[39]] = float(
            (float(struct.unpack("<B", packet[75:76])[0])) / 10
        )
        self.dict[self.items[40]] = float(
            (float(struct.unpack("<B", packet[76:77])[0])) / 10
        )
        self.dict[self.items[41]] = float(
            (float(struct.unpack("<B", packet[77:78])[0])) / 10
        )
        self.dict[self.items[42]] = float(
            (float(struct.unpack("<B", packet[78:79])[0])) / 10
        )
        self.dict[self.items[43]] = float(
            (float(struct.unpack("<B", packet[79:80])[0])) / 10
        )
        self.dict[self.items[44]] = float(
            (float(struct.unpack("<B", packet[80:81])[0])) / 10
        )
        self.dict[self.items[45]] = float(
            (float(struct.unpack("<B", packet[81:82])[0])) / 10
        )
        self.dict[self.items[46]] = float(
            (float(struct.unpack("<B", packet[82:83])[0])) / 10
        )
        self.dict[self.items[47]] = float(
            (float(struct.unpack("<B", packet[83:84])[0])) / 10
        )
        self.dict[self.items[48]] = float(
            (float(struct.unpack("<B", packet[84:85])[0])) / 10
        )
        self.dict[self.items[49]] = float(
            (float(struct.unpack("<B", packet[85:86])[0])) / 10
        )
        self.dict[self.items[50]] = float(
            (float(struct.unpack("<B", packet[86:87])[0])) / 10
        )
        self.dict[self.items[51]] = float(
            (float(struct.unpack("<B", packet[87:88])[0])) / 10
        )
        self.dict[self.items[52]] = float(
            (float(struct.unpack("<B", packet[88:89])[0])) / 10
        )
        self.dict[self.items[53]] = float(
            (float(struct.unpack("<B", packet[89:90])[0])) / 10
        )
        self.dict[self.items[54]] = float(
            (float(struct.unpack("<B", packet[90:91])[0])) / 10
        )
        self.dict[self.items[55]] = float(
            (float(struct.unpack("<B", packet[91:92])[0])) / 10
        )
        self.dict[self.items[56]] = float(
            (float(struct.unpack("<B", packet[92:93])[0])) / 10
        )
        self.dict[self.items[57]] = float(
            (float(struct.unpack("<B", packet[93:94])[0])) / 10
        )
        self.dict[self.items[58]] = float(
            (float(struct.unpack("<B", packet[94:95])[0])) / 10
        )
        self.dict[self.items[59]] = float(
            (float(struct.unpack("<B", packet[95:96])[0])) / 10
        )
        self.dict[self.items[60]] = float(
            (float(struct.unpack("<B", packet[96:97])[0])) / 10
        )
        self.dict[self.items[61]] = float(
            (float(struct.unpack("<B", packet[97:98])[0])) / 10
        )
        self.dict[self.items[62]] = float(
            (float(struct.unpack("<B", packet[98:99])[0])) / 10
        )
        self.dict[self.items[63]] = float(
            (float(struct.unpack("<B", packet[99:100])[0])) / 10
        )
        self.dict[self.items[64]] = float(
            (float(struct.unpack("<B", packet[100:101])[0])) / 10
        )
        self.dict[self.items[65]] = float(
            (float(struct.unpack("<B", packet[101:102])[0])) / 10
        )
        self.dict[self.items[66]] = float(
            (float(struct.unpack("<B", packet[102:103])[0])) / 10
        )
        self.dict[self.items[67]] = float(
            (float(struct.unpack("<B", packet[103:104])[0])) / 10
        )
        self.dict[self.items[68]] = float(
            (float(struct.unpack("<B", packet[104:105])[0])) / 10
        )
        self.dict[self.items[69]] = float(
            (float(struct.unpack("<B", packet[105:106])[0])) / 10
        )
        ...
        self.dict[self.items[98]] = float(
            (float(struct.unpack("<B", packet[134:135])[0])) / 10
        )
        self.dict[self.items[99]] = float(
            (float(struct.unpack("<B", packet[135:136])[0])) / 10
        )
        self.dict[self.items[100]] = float(
            (float(struct.unpack("<B", packet[136:137])[0])) / 10
        )
        self.dict[self.items[101]] = float(
            (float(struct.unpack("<B", packet[137:138])[0])) / 10
        )
        self.dict[self.items[102]] = float(
            (float(struct.unpack("<B", packet[138:139])[0])) / 10
        )
        self.dict[self.items[103]] = float(
            (float(struct.unpack("<i", packet[139:143])[0])) / 100
        )
        self.dict[self.items[104]] = float(
            (float(struct.unpack("<i", packet[143:147])[0])) / 100
        )
        self.dict[self.items[105]] = float(
            (float(struct.unpack("<h", packet[147:149])[0])) / 100
        )
        self.dict[self.items[106]] = float(
            (float(struct.unpack("<B", packet[149:150])[0])) / 100
        )
        self.dict[self.items[107]] = float(
            (float(struct.unpack("<B", packet[150:151])[0])) / 100
        )
        self.dict[self.items[108]] = float(
            (float(struct.unpack("<H", packet[151:153])[0])) / 1
        )
        self.dict[self.items[109]] = float(
            (float(struct.unpack("<H", packet[153:155])[0])) / 100
        )
        self.dict[self.items[110]] = float(
            (float(struct.unpack("<H", packet[155:157])[0])) / 100
        )
        self.dict[self.items[111]] = float(
            (float(struct.unpack("<H", packet[157:159])[0])) / 100
        )
        self.dict[self.items[112]] = float(
            (float(struct.unpack("<H", packet[159:161])[0])) / 100
        )
        self.dict[self.items[113]] = float(
            (float(struct.unpack("<H", packet[161:163])[0])) / 100
        )
        self.dict[self.items[114]] = float(
            (float(struct.unpack("<H", packet[163:165])[0])) / 100
        )
        self.dict[self.items[115]] = float(
            (float(struct.unpack("<H", packet[165:167])[0])) / 100
        )
        self.dict[self.items[116]] = float(
            (float(struct.unpack("<H", packet[167:169])[0])) / 100
        )
        self.dict[self.items[117]] = float(
            (float(struct.unpack("<H", packet[169:171])[0])) / 100
        )
        self.dict[self.items[118]] = float(
            (float(struct.unpack("<H", packet[171:173])[0])) / 100
        )
        self.dict[self.items[119]] = float(
            (float(struct.unpack("<H", packet[173:175])[0])) / 100
        )
        self.dict[self.items[120]] = float(
            (float(struct.unpack("<H", packet[175:177])[0])) / 100
        )
        self.dict[self.items[121]] = float(
            (float(struct.unpack("<H", packet[177:179])[0])) / 100
        )
        self.dict[self.items[122]] = float(
            (float(struct.unpack("<H", packet[179:181])[0])) / 100
        )
        self.dict[self.items[123]] = float(
            (float(struct.unpack("<H", packet[181:183])[0])) / 100
        )
        self.dict[self.items[124]] = float(
            (float(struct.unpack("<H", packet[183:185])[0])) / 100
        )
        self.dict[self.items[125]] = float(
            (float(struct.unpack("<H", packet[185:187])[0])) / 100
        )
        self.dict[self.items[126]] = float(
            (float(struct.unpack("<H", packet[187:189])[0])) / 100
        )
        self.dict[self.items[127]] = float(
            (float(struct.unpack("<H", packet[189:191])[0])) / 100
        )
        self.dict[self.items[128]] = float(
            (float(struct.unpack("<H", packet[191:193])[0])) / 100
        )
        self.dict[self.items[129]] = float(
            (float(struct.unpack("<H", packet[193:195])[0])) / 100
        )
        self.dict[self.items[130]] = float(
            (float(struct.unpack("<H", packet[195:197])[0])) / 100
        )
        self.dict[self.items[131]] = float(
            (float(struct.unpack("<H", packet[197:199])[0])) / 100
        )
        self.dict[self.items[132]] = float(
            (float(struct.unpack("<H", packet[199:201])[0])) / 100
        )
        self.dict[self.items[133]] = int(
            (float(struct.unpack("<I", packet[201:205])[0])) / 1
        )
        self.dict[self.items[134]] = int(
            (float(struct.unpack("<Q", packet[205:213])[0])) / 1
        )
        self.dict[self.items[135]] = int(
            (float(struct.unpack("<I", packet[213:217])[0])) / 1
        )
        self.dict[self.items[136]] = int(
            (float(struct.unpack("<I", packet[217:221])[0])) / 1
        )
        self.dict[self.items[137]] = int(
            (float(struct.unpack("<I", packet[221:225])[0])) / 1
        )
        self.dict[self.items[138]] = int(
            (float(struct.unpack("<B", packet[225:226])[0])) / 1
        )
        self.dict[self.items[139]] = float(
            (float(struct.unpack("<H", packet[226:228])[0])) / 1
        )
        self.dict[self.items[140]] = float(
            (float(struct.unpack("<H", packet[228:230])[0])) / 1
        )
        self.dict[self.items[141]] = float(
            (float(struct.unpack("<H", packet[230:232])[0])) / 1
        )
        self.dict[self.items[142]] = int(
            (float(struct.unpack("<B", packet[232:233])[0])) / 1
        )
        self.dict[self.items[143]] = int(
            (float(struct.unpack("<B", packet[233:234])[0])) / 1
        )
