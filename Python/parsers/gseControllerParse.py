...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Sat Apr  9 00:30:21 2022
...
class GSEController:
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[24]] = float((float(struct.unpack("<h", packet[46:48])[0]))/10)
		self.dict[self.items[25]] = float((float(struct.unpack("<h", packet[48:50])[0]))/10)
