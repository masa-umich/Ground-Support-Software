...
### calibrationParse.py
### Autogenerated by firmware-libraries/SerialComms/python/calibration_file_generator.py on Sat Mar 26 17:27:03 2022
...
class EngineControllerCalibrations:
	...
	def __init__(self):
		...
		self.items[28] = 'pt_cal_offset[0]' 
		self.items[29] = 'pt_cal_offset[1]' 
		self.items[30] = 'pt_cal_offset[2]' 
		self.items[31] = 'pt_cal_offset[3]' 
		self.items[32] = 'pt_cal_offset[4]' 
		self.items[33] = 'pt_cal_offset[5]' 
		self.items[34] = 'pt_cal_offset[6]' 
		self.items[35] = 'pt_cal_offset[7]' 
		self.items[36] = 'pt_cal_offset[8]' 
		self.items[37] = 'pt_cal_offset[9]' 
		self.items[38] = 'pt_cal_offset[10]' 
		self.items[39] = 'pt_cal_offset[11]' 
		self.items[40] = 'pt_cal_offset[12]' 
		self.items[41] = 'pt_cal_offset[13]' 
		self.items[42] = 'pt_cal_offset[14]' 
		self.items[43] = 'pt_cal_offset[15]' 
		self.items[44] = 'pt_cal_offset[16]' 
		self.items[45] = 'pt_cal_offset[17]' 
		self.items[46] = 'pt_cal_offset[18]' 
		self.items[47] = 'pt_cal_offset[19]' 
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[28]] = float((float(struct.unpack("<h", packet[92:94])[0]))/1)
		self.dict[self.items[29]] = float((float(struct.unpack("<h", packet[94:96])[0]))/1)
		self.dict[self.items[30]] = float((float(struct.unpack("<h", packet[96:98])[0]))/1)
		self.dict[self.items[31]] = float((float(struct.unpack("<h", packet[98:100])[0]))/1)
		self.dict[self.items[32]] = float((float(struct.unpack("<h", packet[100:102])[0]))/1)
		self.dict[self.items[33]] = float((float(struct.unpack("<h", packet[102:104])[0]))/1)
		self.dict[self.items[34]] = float((float(struct.unpack("<h", packet[104:106])[0]))/1)
		self.dict[self.items[35]] = float((float(struct.unpack("<h", packet[106:108])[0]))/1)
		self.dict[self.items[36]] = float((float(struct.unpack("<h", packet[108:110])[0]))/1)
		self.dict[self.items[37]] = float((float(struct.unpack("<h", packet[110:112])[0]))/1)
		self.dict[self.items[38]] = float((float(struct.unpack("<h", packet[112:114])[0]))/1)
		self.dict[self.items[39]] = float((float(struct.unpack("<h", packet[114:116])[0]))/1)
		self.dict[self.items[40]] = float((float(struct.unpack("<h", packet[116:118])[0]))/1)
		self.dict[self.items[41]] = float((float(struct.unpack("<h", packet[118:120])[0]))/1)
		self.dict[self.items[42]] = float((float(struct.unpack("<h", packet[120:122])[0]))/1)
		self.dict[self.items[43]] = float((float(struct.unpack("<h", packet[122:124])[0]))/1)
		self.dict[self.items[44]] = float((float(struct.unpack("<h", packet[124:126])[0]))/1)
		self.dict[self.items[45]] = float((float(struct.unpack("<h", packet[126:128])[0]))/1)
		self.dict[self.items[46]] = float((float(struct.unpack("<h", packet[128:130])[0]))/1)
		self.dict[self.items[47]] = float((float(struct.unpack("<h", packet[130:132])[0]))/1)
