...
class PressurizationController:
	...
	def __init__(self):
		...
		self.items[59] = 'mtr0.kp' 
		self.items[60] = 'mtr1.kp' 
		self.items[61] = 'mtr0.ki' 
		self.items[62] = 'mtr1.ki' 
		self.items[63] = 'mtr0.kd' 
		self.items[64] = 'mtr1.kd' 
		...
		self.items[71] = 'tnk0.target_pres' 
		self.items[72] = 'tnk1.target_pres' 
		self.items[73] = 'tnk0.high_pres' 
		self.items[74] = 'tnk1.high_pres' 
		self.items[75] = 'tnk0.low_pres' 
		self.items[76] = 'tnk1.low_pres' 
		self.items[77] = 'pot0.e' 
		self.items[78] = 'pot1.e' 
		...
		self.items[98] = 'chamber_pressure_low_count' 
