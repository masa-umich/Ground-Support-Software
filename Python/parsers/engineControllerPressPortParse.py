...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Tue Aug 17 22:03:21 2021
...
class PressurizationController:
	...
	def __init__(self):
		...
		self.items[104] = 'fuel_vent_telem_count' 
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[104]] = int((float(struct.unpack("<B", packet[213:214])[0]))/1)
