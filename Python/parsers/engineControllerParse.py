...
class EngineController:
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[17]] = float((float(struct.unpack("<i", packet[26:30])[0]))/1)
		self.dict[self.items[18]] = float((float(struct.unpack("<i", packet[30:34])[0]))/1)
		self.dict[self.items[19]] = float((float(struct.unpack("<i", packet[34:38])[0]))/1)
		self.dict[self.items[20]] = float((float(struct.unpack("<i", packet[38:42])[0]))/1)
		self.dict[self.items[21]] = float((float(struct.unpack("<i", packet[42:46])[0]))/1)
		self.dict[self.items[22]] = float((float(struct.unpack("<i", packet[46:50])[0]))/1)
		self.dict[self.items[23]] = float((float(struct.unpack("<i", packet[50:54])[0]))/1)
		self.dict[self.items[24]] = float((float(struct.unpack("<i", packet[54:58])[0]))/1)
		self.dict[self.items[25]] = float((float(struct.unpack("<i", packet[58:62])[0]))/1)
		self.dict[self.items[26]] = float((float(struct.unpack("<i", packet[62:66])[0]))/1)
		self.dict[self.items[27]] = float((float(struct.unpack("<i", packet[66:70])[0]))/1)
		self.dict[self.items[28]] = float((float(struct.unpack("<i", packet[70:74])[0]))/1)
		self.dict[self.items[29]] = float((float(struct.unpack("<i", packet[74:78])[0]))/1)
		self.dict[self.items[30]] = float((float(struct.unpack("<i", packet[78:82])[0]))/1)
		self.dict[self.items[31]] = float((float(struct.unpack("<i", packet[82:86])[0]))/1)
		self.dict[self.items[32]] = float((float(struct.unpack("<i", packet[86:90])[0]))/1)
		self.dict[self.items[33]] = float((float(struct.unpack("<i", packet[90:94])[0]))/1)
		self.dict[self.items[34]] = float((float(struct.unpack("<i", packet[94:98])[0]))/1)
		self.dict[self.items[35]] = float((float(struct.unpack("<i", packet[98:102])[0]))/1)
		self.dict[self.items[36]] = float((float(struct.unpack("<i", packet[102:106])[0]))/1)
