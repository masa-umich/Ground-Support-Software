...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Sat Jan 23 18:57:54 2021
...
class TelemParse:
	...
	def __init__(self):
		self.csv_header = "Time (s),valve_states (ul),pressure[0] (psi),pressure[1] (psi),pressure[2] (psi),pressure[3] (psi),pressure[4] (psi),pressure[5] (psi),e_batt (Volts),i_batt (Amps),STATE (ul),vlv0.i (Amps),vlv1.i (Amps),vlv2.i (Amps),vlv3.i (Amps),vlv4.i (Amps),vlv5.i (Amps),vlv6.i (Amps),vlv7.i (Amps),vlv8.i (Amps),vlv0.e (Volts),vlv1.e (Volts),vlv2.e (Volts),vlv3.e (Volts),vlv4.e (Volts),vlv5.e (Volts),vlv6.e (Volts),vlv7.e (Volts),vlv8.e (Volts),e3v (Volts),e5v (Volts),i5v (Amps),i3v (Amps),last_command_id (ul),tc[0] (K),tc[1] (K),tc[2] (K),tc[3] (K),tc[4] (K),i_mtr_ab[0] (Amps),i_mtr_ab[1] (Amps),i_mtr_ab[2] (Amps),i_mtr_ab[3] (Amps),i_mtr[0] (Amps),i_mtr[1] (Amps),mtr_pos[0] (deg),mtr_pos[1] (deg),mtr_set[0] (deg),mtr_set[1] (deg),mtr_ki[0] (ul),mtr_ki[1] (ul),mtr_kd[0] (ul),mtr_kd[1] (ul),mtr_kp[0] (ul),mtr_kp[1] (ul),epot[0] (Volts),epot[1] (Volts),epot[2] (Volts),epot[3] (Volts),micros (us),telem_rate (Hz),adc_rate (Hz),flash_mem (bytes),own_board_addr (ul),\n"
		self.log_string = ""
		self.num_items = 70
		...
		self.items[53] = 'mtr_set[0]' 
		self.items[54] = 'mtr_set[1]' 
		self.items[55] = 'mtr_ki[0]' 
		self.items[56] = 'mtr_ki[1]' 
		self.items[57] = 'mtr_kd[0]' 
		self.items[58] = 'mtr_kd[1]' 
		self.items[59] = 'mtr_kp[0]' 
		self.items[60] = 'mtr_kp[1]' 
