...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Sun Jan 24 18:30:27 2021
...
class TelemParse:
	...
	def __init__(self):
		...
		self.items[61] = 'mtr0.kp_err' 
		self.items[62] = 'mtr1.kp_err' 
		self.items[63] = 'mtr0.ki_err' 
		self.items[64] = 'mtr1.ki_err' 
		self.items[65] = 'mtr0.kd_err' 
		self.items[66] = 'mtr1.kd_err' 
		self.items[67] = 'epot[0]' 
		self.items[68] = 'epot[1]' 
		self.items[69] = 'epot[2]' 
		self.items[70] = 'epot[3]' 
		self.items[71] = 'micros' 
		self.items[72] = 'telem_rate' 
		self.items[73] = 'adc_rate' 
		self.items[74] = 'flash_mem' 
		self.items[75] = 'own_board_addr' 
		...
		self.units[self.items[71]] = "us"
		self.units[self.items[72]] = "Hz"
		self.units[self.items[73]] = "Hz"
		self.units[self.items[74]] = "bytes"
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[53]] = float((float(struct.unpack("<h", packet[88:90])[0]))/10)
		self.dict[self.items[54]] = float((float(struct.unpack("<h", packet[90:92])[0]))/10)
