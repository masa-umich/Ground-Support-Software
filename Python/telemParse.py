...
### telemParse.py
### Autogenerated by firmware-libraries/SerialComms/python/telem_file_generator.py on Thu Feb 18 17:20:55 2021
...
class TelemParse:
	...
	def parse_packet(self, packet):
		...
		self.dict[self.items[75]] = float((float(struct.unpack("<h", packet[132:134])[0]))/10)
		self.dict[self.items[76]] = float((float(struct.unpack("<h", packet[134:136])[0]))/10)
		self.dict[self.items[77]] = float((float(struct.unpack("<h", packet[136:138])[0]))/10)
		self.dict[self.items[78]] = float((float(struct.unpack("<h", packet[138:140])[0]))/10)
