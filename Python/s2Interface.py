...
from parsers.engineControllerPressPortParseCalibration import PressurizationControllerCalibrations
...
class S2_Interface:
    def __init__(self, ser=serial.Serial(port=None)):
        ...
        self.calibration_parser = [None, None, None, PressurizationControllerCalibrations(), None]
