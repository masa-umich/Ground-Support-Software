...
from parsers.engineControllerPressPortCalibrationParse import PressurizationControllerCalibrations
...
class S2_Interface:
    ...
    """
    def download_flash(self, target_board_addr, timestamp, command_log, filepath, progress_callback_func=None):
        cmd_info = dict()
        ...
        try:
            with open(os.path.join(datadir, filename), "wb+") as binfile:   # Open the binary
                ...
                command_log.write(Constants.getCurrentTimestamp()+",From Board," + str(cmd_info) + '\n')
